export const clientsData = {
  cii: {
    ...
    videos: [
      {
        id: "jlR54SuB_Rc",
        tag: "CII | INDIA @ 75 SUMMIT",
        title: "India @ 75 — Corporate Aftermovie",
        desc: "Highlighting key speeches, corporate leadership panels, and industrial growth insights from the landmark India @ 75 national summit in Bengaluru."
      }
    ],
    slug: "cii"
  },
  cgi: {
    ...
    tagline: "Capturing CGI’s Global-Local Digital Engine",
    videos: [
      {
        id: "t07kSRBHPfg",
        tag: "CGI BANGALORE | CORPORATE SHOWCASE",
        title: "CGI Bengaluru — Corporate Facility & Culture",
        desc: "A corporate showcase film walking through CGI's state-of-the-art office infrastructure and collaborative workplace culture in Bangalore."
      }
    ],
    slug: "cgi"
  },
  toyota: {
    ...
    tagline: "Driving Change—On the Road and in Communities",
    videos: [
      {
        id: "e5J2v1UtFW4",
        tag: "TOYOTA KIRLOSKAR MOTOR | CSR INITIATIVES",
        title: "Toyota Kirloskar — CSR School Transformation",
        desc: "A heartwarming brand documentary detailing Toyota's social contribution and physical transformation of the GHBS Hejala school."
      }
    ],
    slug: "toyota"
  },
  tcs: {
    ...
    tagline: "Framing the Future of Technology with TCS",
    videos: [],
    slug: "tcs"
  },
  rtx: {
    ...
    tagline: "Spotlighting RTX’s Aerospace Leadership in Flight",
    videos: [],
    slug: "rtx"
  },
  "tata-elxsi": {
    ...
    tagline: "Design Led Innovation in Unmanned Systems",
    videos: [
      {
        id: "SpD8AeoLTXw",
        tag: "TATA ELXSI | AEROSPACE INNOVATION",
        title: "Tata Elxsi — Autonomous UAV Technology",
        desc: "Visualizing the design-led engineering, biomimicry, and autonomous intelligence powering Tata Elxsi's modern unmanned systems."
      }
    ],
    slug: "tata-elxsi"
  },
  presidency: {
    ...
    tagline: "Framing Learning, Celebrating Legacy",
    videos: [
      {
        id: "doOSgmHHgD4",
        tag: "PRESIDENCY UNIVERSITY",
        title: "Invincia 2026 — Annual Cultural Fest",
        desc: "A high-energy aftermovie capturing the vibrancy, scale, and electric performances of Presidency University's flagship annual cultural festival."
      },
      {
        id: "df1A-_FulEs",
        tag: "PRESIDENCY UNIVERSITY",
        title: "Divine x Ananya — Live Concert Film",
        desc: "A cinematic concert film capturing the stellar live performances, crowd energy, and musical highlights from the college campus show."
      },
      {
        id: "XulH5TjS50k",
        tag: "PRESIDENCY SCHOOL BANGALORE",
      ...
      {
        id: "cImmLgZo9-Y",
        tag: "PRESIDENCY PU COLLEGE, YELAHANKA",
  ...
  pai: {
    ...
    tagline: "Showcasing Retail Innovation, One Frame at a Time",
    videos: [
      {
        id: "C0hzCKpITSE",
        tag: "PAI INTERNATIONAL | BRAND DOCUMENTARY",
        title: "PAI International — Lowest Price Challenge",
        desc: "A dynamic retail commercial promoting PAI's price guarantee campaigns and seasonal customer electronics discount offers."
      },
      {
        id: "xzKI4XmfFus",
        tag: "PAI INTERNATIONAL | BRAND TRUST",
        title: "PAI Electronics — Customer Trust Journey",
        desc: "Capturing customer stories, store highlights, and two decades of retail trust built across Karnataka and Andhra Pradesh."
      },
      {
        id: "av9FhaYzDuA",
        tag: "PAI INTERNATIONAL | MOBILE FESTIVAL",
        title: "PAI Mobile Fest — Promotional Ad",
        desc: "An energetic social media campaign advertisement showcasing exclusive brand deals, lucky coupons, and offers during the PAI Mobile Festival."
      }
    ],
    slug: "pai"
  },
