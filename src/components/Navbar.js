  ...
  return (
    <>
      ...
      >
        ...
        <div className={`flex flex-col items-center gap-[12px] mt-[20px] transition-all duration-700 delay-500 ${mobileOpen ? 'opacity-80 translate-y-0' : 'opacity-0 translate-y-[20px]'}`}>
          ...
          <div className="flex gap-[20px] items-center">
            {[
              ...
              },
              {
                ...
                svg: (
                  <svg className="w-[18px] h-[18px]" xmlns='http://www.w3.org/2000/svg' viewBox='0 0 576 512'>
              ...
              <a 
                ...
                className="text-[rgba(255,255,255,0.6)] hover:text-[var(--gold)] transition-colors duration-300 cursor-pointer"
              >
                {social.svg}
              </a>
            ))}
