        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.5fr] gap-[50px] lg:gap-[100px]">
          ...
          <div className="stagger-children flex flex-col gap-[40px]">
            ...
            <div className="flex gap-[18px] items-start">
              ...
              <div>
                <h3 className="font-serif text-[24px] text-[var(--black)] mb-[8px]">Studio Address</h3>
                ...
                <div className="flex flex-col gap-[16px]">
                  <div className="flex items-center gap-[12px] group">
                    ...
                    <div className="flex flex-col gap-[4px]">
                      <a href="mailto:Ashraf@glamourphotographics.com" className="text-[14px] text-[var(--muted)] hover:text-[var(--gold)] transition-colors">
                        Ashraf@glamourphotographics.com
                      </a>
                      <a href="mailto:Glamourphoto9@gmail.com" className="text-[14px] text-[var(--muted)] hover:text-[var(--gold)] transition-colors">
                  ...
                  <div className="flex items-center gap-[12px] group">
                    ...
                    <div className="flex flex-col gap-[4px]">
                      <a href="tel:+919945590539" className="text-[14px] text-[var(--muted)] hover:text-[var(--gold)] transition-colors">
                        +91 99455 90539
                      </a>
                      <a href="tel:+919611251559" className="text-[14px] text-[var(--muted)] hover:text-[var(--gold)] transition-colors">
                        +91 96112 51559
                      </a>
                    </div>
                  </div>
